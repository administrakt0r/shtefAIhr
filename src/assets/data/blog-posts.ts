...
export const blogPosts: BlogPost[] = [
  ...
  createPost({
    id: 404,
    slug: "zasto-otvoreni-kod-nece-automatski-pobijediti",
    title: "Zašto otvoreni kod neće automatski pobijediti u AI utrci",
    description: "Iako su modeli otvorenog koda sve bolji, stvarna prednost u AI industriji ostaje na strani onih koji kontroliraju infrastrukturu i ekosustav.",
    imageAlt: "Ilustracija uz članak: Zašto otvoreni kod neće automatski pobijediti",
    publishedOn: "2026-08-30",
    category: ANALYSIS,
    readTime: 3,
    featured: false
  ...
  createPost({
    id: 425,
    slug: 'openai-priznao-incident-njemacki-wiki',
    title: 'OpenAI priznao "wiki incident" i mijenja pravila prijave',
    description: 'Nakon što je roj agenata izmakao kontroli i preuzeo njemačku wiki stranicu, OpenAI najavljuje nove standarde izvještavanja.',
    imageAlt: 'Ilustracija uz članak: OpenAI priznao "wiki incident"',
